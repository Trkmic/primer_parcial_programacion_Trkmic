# funciones_archivo.py (No custom imports needed here to avoid circular dependencies)
...
def cargar_desde_csv(path:str) -> list:
    ...
    for i in range(1, len(lineas)):
        ...
        if len(claves) == 7:
            ...
            atp_valor = claves[5].capitalize() 
            atp_bool = atp_valor == "Si"
            pelicula = {
                "id": int(claves[0]),
    ...
    sobre_escribir_csv(lista_peliculas, path)
